...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'blogger_blog.twig.extension.bloggerblogextension' => 'getBloggerBlog_Twig_Extension_BloggerblogextensionService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/wwwroot/symfony2_blog/app/cache/test/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/home/wwwroot/symfony2_blog/app/cache/test/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/wwwroot/symfony2_blog/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    /**
     * Gets the 'blogger_blog.twig.extension.bloggerblogextension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBloggerBlog_Twig_Extension_BloggerblogextensionService()
    {
        return $this->services['blogger_blog.twig.extension.bloggerblogextension'] = new \Blogger\BlogBundle\Twig\Extensions\BloggerBlogExtension();
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/wwwroot/symfony2_blog/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/wwwroot/symfony2_blog/src/Blogger/BlogBundle/Entity')), 'Blogger\\BlogBundle\\Entity');
        ...
        $b->setProxyDir('/home/wwwroot/symfony2_blog/app/cache/test/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_de7c17cfa188d21e86a91a80706a64bdcfc611a173f4d5902de7fd1e7200b524');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/wwwroot/symfony2_blog/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/wwwroot/symfony2_blog/app/logs/test.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/wwwroot/symfony2_blog/app/cache/test/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/wwwroot/symfony2_blog/app/cache/test/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/wwwroot/symfony2_blog/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/wwwroot/symfony2_blog/app/cache/test/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/wwwroot/symfony2_blog/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/wwwroot/symfony2_blog/app/cache/test/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/wwwroot/symfony2_blog/app/cache/test/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/wwwroot/symfony2_blog/app', 'UTF-8'));
        ...
        $instance->addExtension($this->get('blogger_blog.twig.extension.bloggerblogextension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/wwwroot/symfony2_blog/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/wwwroot/symfony2_blog/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/wwwroot/symfony2_blog/app/Resources/views');
        $instance->addPath('/home/wwwroot/symfony2_blog/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/home/wwwroot/symfony2_blog/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/wwwroot/symfony2_blog/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/wwwroot/symfony2_blog/app/cache/test/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/wwwroot/symfony2_blog/app/cache/test');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/wwwroot/symfony2_blog/app',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/wwwroot/symfony2_blog/app/cache/test',
            'kernel.logs_dir' => '/home/wwwroot/symfony2_blog/app/logs',
            ...
            'mailer_user' => 'dc@weststarinc.co',
            'mailer_password' => 14779023,
            'locale' => 'en',
            ...
            'debug.container.dump' => '/home/wwwroot/symfony2_blog/app/cache/test/appTestDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/wwwroot/symfony2_blog/app/cache/test/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/wwwroot/symfony2_blog/app/cache/test/profiler',
            ...
            'router.resource' => '/home/wwwroot/symfony2_blog/app/cache/test/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/wwwroot/symfony2_blog/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'dc@weststarinc.co',
            'swiftmailer.mailer.default.transport.smtp.password' => 14779023,
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.spool.default.memory.path' => '/home/wwwroot/symfony2_blog/app/cache/test/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/wwwroot/symfony2_blog/app/cache/test/assetic',
            ...
            'assetic.read_from' => '/home/wwwroot/symfony2_blog/app/../web',
            'assetic.write_to' => '/home/wwwroot/symfony2_blog/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/wwwroot/symfony2_blog/app/cache/test/doctrine/orm/Proxies',
